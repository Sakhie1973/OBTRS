...
Route::get('/vehicleprofile/{number}', 'AdminController@vehicleprofile')->name('vehicleprofile');
Route::get('/assignto/{number}/vehicle/{vehicle}', 'AdminController@assignto');
Route::get('/deletefleet/{number}', 'AdminController@deletefleet');


Route::get('/drivers', 'AdminController@drivers')->name('drivers');
Route::post('/adddriver', 'AdminController@adddriver')->name('adddriver');

Route::get('/profile', 'AdminController@profile')->name('profile');
Route::get('/vehicleprofile/{id}', 'AdminController@vehicleprofile')->name('vehicleprofile');
...
Route::get('/operatorreport', 'AdminController@operatorreport')->name('operatorreport');
Route::get('/operatortotalreport', 'AdminController@operatortotalreport')->name('operatortotalreport');
...
Route::post('addfleet', 'AdminController@addfleet')->name('addfleet');
Route::post('addTrip', 'AdminController@addTripp')->name('addTripp');
