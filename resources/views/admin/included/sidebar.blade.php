  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      ...
      <a href="#" class="nav-link">
        <img src="{{ asset('img/logo2.jpg') }}" style="height: inherit;" alt="Logo" class="brand-image img-circle">
        <span class="brand-text font-weight-bold">Sakhepi Logistics</span>
      </a>
    </li>
  </ul>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{!! route('operator') !!}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{!! route('operator') !!}" class="nav-link">
                <i class="fas fa-bus nav-icon orange"></i>
                <p>Fleet </p>
              </a>
            </li>
          ...
          <li class="nav-item">
          <a href="{!! route('operator') !!}" class="nav-link">
            <i class="nav-icon fa fa-chart-bar blue"></i>
            <p>
              Report Management
               <i class="right fa fa-angle-left"></i>
            </p>
            ...
            <li class="nav-item">
              <a href="{!! route('operatorreport') !!}" class="nav-link">
                <i class="fas fa-bus nav-icon orange"></i>
                <p>Fleet report</p>
              </a>
            </li>
             ...
             <li class="nav-item">
              <a href="{!! route('operatortotalreport') !!}" class="nav-link">
                <i class="fas fa-bus nav-icon orange"></i>
                <p>Trip report</p>
              </a>
            </li>
